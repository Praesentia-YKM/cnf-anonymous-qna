  ...
  return (
    <form onSubmit={handleSubmit} className="pt-2 space-y-2">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-xs text-gray-600 dark:text-gray-400 font-medium">{nickname || "익명"}</span>
      </div>
      <Textarea
      ...
      <div className="flex justify-between items-center">
        <span className="text-[10px] text-gray-500 dark:text-gray-400">{content.length}/500</span>
        <Button
          type="submit"
          size="sm"
